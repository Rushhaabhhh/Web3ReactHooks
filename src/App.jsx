        ...
        <div className="container mx-auto py-4 flex justify-between items-center">
          ...
          <div className="flex space-x-6 text-lg font-semibold justify-center flex-grow">
            ...
            <Link
              ...
              aria-label="Navigate to Demonstration Section"
            >
              Demonstration
            </Link>
            <Link
              ...
              duration={500}
              className="hover:text-[#1e90ff] transition duration-300 cursor-pointer"
              aria-label="Navigate to Code Samples Section"
            >
              Code Samples
            </Link>
            <a
              ...
              className="hover:text-[#1e90ff] transition duration-300 cursor-pointer"
              aria-label="Visit Web3 React Hooks GitHub Repository"
            >
              GitHub
            </a>
          </div>
      ...
      <div className="py-40 bg-transparent" id="home">
        <div className="container mx-auto px-6 flex justify-between items-center">
          <div className="flex-1">
            ...
            >
              <span>A Simple Solution of Web3 Integration</span>
              <br />
